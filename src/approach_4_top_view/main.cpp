...
using namespace struct_templated_field; // data classes only
// using namespace View::struct_templated_field; // if you want to access Views instead
// namespace STFV = View::struct_templated_field; // also possible
...
template <class T>
void print(View::struct_templated_field::Field<T> field)
{
